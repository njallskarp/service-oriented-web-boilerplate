import { AllEnvironmentVariabls, Environment } from "./config"
...
for(const key in environment){
    ...
    const printValue = shouldMask ? "****" + environment[key as AllEnvironmentVariabls]?.slice(-4) : environment[key as AllEnvironmentVariabls]
